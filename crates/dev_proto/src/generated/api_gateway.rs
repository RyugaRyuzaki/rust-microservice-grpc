...
pub mod api_gateway_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn login(
            &mut self,
            request: impl tonic::IntoRequest<super::super::auth::LoginRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::auth::LoginResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/api_gateway.ApiGateway/Login",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("api_gateway.ApiGateway", "Login"));
...
pub mod api_gateway_server {
    ...
    pub trait ApiGateway: std::marker::Send + std::marker::Sync + 'static {
        async fn login(
            &self,
            request: tonic::Request<super::super::auth::LoginRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::auth::LoginResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/api_gateway.ApiGateway/Login" => {
                    ...
                    struct LoginSvc<T: ApiGateway>(pub Arc<T>);
                    impl<
                        T: ApiGateway,
                    > tonic::server::UnaryService<super::super::auth::LoginRequest>
                    for LoginSvc<T> {
                        type Response = super::super::auth::LoginResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as ApiGateway>::login(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "api_gateway.ApiGateway";
